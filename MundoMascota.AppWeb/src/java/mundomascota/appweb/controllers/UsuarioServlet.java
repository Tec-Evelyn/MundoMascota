...
import mundomascota.accesoadatos.RolDAL;
import mundomascota.accesoadatos.UsuarioDAL;
import mundomascota.appweb.utils.*;
import mundomascota.entidadesdenegocio.Rol;
import mundomascota.entidadesdenegocio.Usuario;
...
public class UsuarioServlet extends HttpServlet {
    ...
    private Usuario obtenerUsuario(HttpServletRequest request) {
        ...
        usuario.setTelefono(Utilidad.getParameter(request, "telefono", ""));
        usuario.setDireccion(Utilidad.getParameter(request, "direccion", ""));
