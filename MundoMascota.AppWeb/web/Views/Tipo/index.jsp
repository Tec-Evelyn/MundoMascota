...
<% ArrayList<Tipo> tipos = (ArrayList<Tipo>) request.getAttribute("tipos");
    ...
    if (tipos == null) {
        tipos = new ArrayList();
    } else if (tipos.size() > numReg) {
        double divNumPage = (double) tipos.size() / (double) numReg;
                                ...
                                <tr data-page="<%= tempNumPage%>">
                                    ...
                                    <td>
                                        <div style="display:flex">
                                            ...
                                            <a href="Tipo?accion=delete&id=<%=tipo.getId()%>" title="Eliminar" class="waves-effect waves-light btn red">
